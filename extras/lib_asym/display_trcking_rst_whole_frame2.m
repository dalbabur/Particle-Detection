function [Small]=display_trcking_rst_whole_frame2(data,bgImg,pathName,fileName,info,LinLUT, halfHeight, halfWidth)

rstImg = bgImg;

for i = 1:size(data,1)
    %data(i,5)-info.startFrame+1
    ...
    Small=forImg(minH:maxH, minW:maxW);
end
