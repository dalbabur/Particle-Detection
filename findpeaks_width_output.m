function [Ypk,Xpk,Wpk,Ppk,Wind] = findpeaks_width_output(Yin,varargin)
...
if nargout > 0
  ...
  if needWidth
    [Ypk,Xpk,Wpk,Ppk,Wind] = assignFullOutputs(y,x,iPk,wxPk,bPk,yIsRow,xIsRow);
  else
...
%--------------------------------------------------------------------------
function [YpkOut,XpkOut,WpkOut,PpkOut,widthindices] = assignFullOutputs(y,x,iPk,wxPk,bPk,yIsRow,xIsRow)
coder.internal.prefer_const(yIsRow,xIsRow);
